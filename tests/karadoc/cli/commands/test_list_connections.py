...
class TestListConnections(unittest.TestCase):
    ...
    def test_list_connections_with_markdown_output(self):
        ...
        expected = (
            ...
            "|:----------------------------|:---------------|:---------------|:---------------------------------------|:------------|:-------|:-----------|:------------|:-----------|:--------|:---------------|:----------------|\n"  # noqa: E501
            "| test_schema.disabled        | SparkBatchJob  | dummy_disabled | tests.resources.spark.connectors.dummy | input       |        |            |             |            |         | True           | True            |\n"  # noqa: E501
            "| test_schema.disabled        | SparkStreamJob | dummy_disabled | tests.resources.spark.connectors.dummy | input       |        |            |             |            |         | True           | True            |\n"  # noqa: E501
            "| test_schema.external_input  | SparkBatchJob  | dummy          | tests.resources.spark.connectors.dummy | input       |        |            |             |            |         | False          | False           |\n"  # noqa: E501
            "| test_schema.external_input  | SparkStreamJob | dummy          | tests.resources.spark.connectors.dummy | input       |        |            |             |            |         | False          | False           |\n"  # noqa: E501
            "| test_schema.external_output | SparkBatchJob  | dummy          | tests.resources.spark.connectors.dummy | output      |        |            |             |            |         | False          | False           |\n"  # noqa: E501
            "| test_schema.external_output | SparkBatchJob  | dummy          | tests.resources.spark.connectors.dummy | output      |        |            |             |            |         | False          | False           |\n"  # noqa: E501
            "| test_schema.external_output | SparkStreamJob | dummy          | tests.resources.spark.connectors.dummy | output      |        |            |             |            |         | False          | False           |"  # noqa: E501
        )
        print(actual)
    ...
    def test_list_connections_with_csv_output(self):
        ...
        expected = (
            ...
            "test_schema.external_output,SparkBatchJob,dummy,tests.resources.spark.connectors.dummy,output,,,,,,False,False\n"  # noqa: E501
            "test_schema.external_output,SparkBatchJob,dummy,tests.resources.spark.connectors.dummy,output,,,,,,False,False\n"  # noqa: E501
            "test_schema.external_output,SparkStreamJob,dummy,tests.resources.spark.connectors.dummy,output,,,,,,False,False\n"  # noqa: E501
        )
        self.assertEqual(expected, actual)
