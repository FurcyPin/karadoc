...
class TestValidate(unittest.TestCase):
    ...
    @mock_settings_for_test({"model_dir": "tests/resources/karadoc/cli/commands/test_validate/model_ok"})
    ...
    def test_validate_multiple_envs(self):
        ...
        dynaconf.settings = Settings(
            "tests/resources/karadoc/cli/commands/test_validate/model_with_connectors/settings.toml"
        )
        try:
