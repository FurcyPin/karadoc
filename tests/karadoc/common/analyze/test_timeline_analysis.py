...
from karadoc.common.analyze import timeline_analysis
...
class TestTimelineAnalysis(pyspark_test_class.PySparkTest):
    ...
    def test_get_always_null_columns(self):
        df = self.spark.read.option("header", "true").csv(
            "tests/resources/karadoc/common/analyze/test_timeline_analysis/sample_file"
        )
    ...
    def test_analyse_timeline(self):
        ...
        df = (
            ...
            .csv("tests/resources/karadoc/common/analyze/test_timeline_analysis/sample_file")
        )
